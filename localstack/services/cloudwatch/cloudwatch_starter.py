...
def apply_patches():
    ...
    def update_state(target, self, reason, reason_data, state_value):
        ...
        if self.actions_enabled and old_state != self.state_value:
            actions = None
...
def create_message_response_update_state(alarm, old_state):
    ...
    details = {
        ...
        "Unit": alarm.unit or "",
        "Period": alarm.period or "",
        "EvaluationPeriods": alarm.evaluation_periods or "",
        "ComparisonOperator": alarm.comparison_operator or "",
        "Threshold": alarm.threshold or "",
    ...
    if alarm.statistic:
        ...
        details["Statistic"] = alarm.statistic
